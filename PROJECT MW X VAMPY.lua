...
local Passwords = {"1"}
local Menu = gg.prompt({"📛 ᴇɴᴛᴇʀ ᴠɪᴘ ᴋᴇʏ 📛"},nil,{"TEXT"})
...
gg.alert("❤️ ᴠ ᴀ ᴍ ᴘ ʏ  Fᴏʀ GG Uꜱᴇʀꜱ V2 ❤️  ", "⫷E ɴ T ᴇ R⫸","")
...
msg = os.date("        🔥 ᴠ ᴀ ᴍ ᴘ ʏ 一 ꜰᴏʀ ɢɢ ᴜꜱᴇʀꜱ 🔥\n━━━━━━━━━━━━━━━━━━━━━━\n⚜️ ᴛᴇʟᴇɢʀᴀᴍ : @bravo6ixx\n⚜️ ᴛɪᴍᴇ  【%I:%M%p %B%d】\n━━━━━━━━━━━━━━━━━━━━━━")
...
function HOME()
  SN = gg.choice({
       ...
       "🌀➔ ꜱᴋɪɴ ᴍᴇɴᴜ",
       "❌ Σ X I Ƭ ❌"
}, nil,"🔥 ᴠ ᴀ ᴍ ᴘ ʏ 一 Fᴏʀ GG Uꜱᴇʀꜱ V2 🔥")
 if SN == nil then
    else
    if SN == 1 then
      EMUBP()
...
function EMUBP()
  MN8 = gg.multiChoice({
          "➾ ᴇᴍᴜʟᴀᴛᴏʀ ʙᴘ xᴀ ʙᴀꜱᴇᴅ",
          "➾ ᴇᴍᴜʟᴀᴛᴏʀ ʙᴘ ᴛᴇʀꜱᴀꜰᴇ ʙᴀꜱᴇᴅ",
          "➾ ᴇᴍᴜʟᴀᴛᴏʀ ʙᴘ ᴜᴇ4 ʙᴀꜱᴇᴅ",
          " ⫷ B Λ C K ⫸ "
}, nil,"🔰ʟᴏɢᴏ ᴀɴɪᴛʙᴀɴ ɪɴʙᴜɪʟᴇᴅ ᴡɪᴛʜ ᴇᴀᴄʜ ʙʏᴘᴀꜱꜱ一🔥 ᴠ ᴀ ᴍ ᴘ ʏ 🔥")
    if MN8 == nil then
    else
      if MN8[1] == true then
        EMUV1()
...
setvalue(W+m,16,-2.0291021e20)
  ...
  gg.alert("ᴇᴍᴜʟᴀᴛᴏʀ ʙᴘ xᴀ ʙᴀꜱᴇᴅ+ʟᴏɢᴏ ᴀɴᴛɪʙᴀɴ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
setvalue(W+m,16,-2.0291021e20)
    gg.processResume()
    gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
    gg.alert("ᴇᴍᴜʟᴀᴛᴏʀ ʙᴘ ᴛᴇʀꜱᴀꜰᴇ ʙᴀꜱᴇᴅ+ʟᴏɢᴏ ᴀɴᴛɪʙᴀɴ ᴠ ᴛᴡᴏ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")   
    end
...
function EMUV3()
  ...
  gg.processResume()
  gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
  gg.alert("ᴇᴍᴜʟᴀᴛᴏʀ ʙᴘ ᴜᴇ4 ʙᴀꜱᴇᴅ+ʟᴏɢᴏ ᴀɴᴛɪʙᴀɴ ᴠ ᴛᴡᴏ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")   
end
...
function ANTIBAN()
  MN8 = gg.multiChoice({
          ...
          "➾ ᴄʟᴇᴀʀ ʟᴏɢ",
          " ⫷ B Λ C K ⫸ "
}, nil,"🔰ᴅᴏɴᴛ ᴜꜱᴇ ᴀʟʟ ᴀɴᴛɪʙᴀɴ一🔥 ᴠ ᴀ ᴍ ᴘ ʏ 🔥")
    if MN8 == nil then
    else
      if MN8[1] == true then
        ANTIV1()
...
gg.clearResults()
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ᴀɴᴛɪʙᴀɴ ᴠ 1 ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
gg.clearResults()
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ᴀɴᴛɪʙᴀɴ ᴠ 2 ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
function ANTIV3()
  ...
  gg.getResults(50000)
  gg.editAll("288233678981562368", gg.TYPE_QWORD)
  gg.toast("ɴᴏ ғᴇᴇᴅʙᴀᴄᴋ ɴᴏ ᴜᴘᴅᴀᴛᴇ")
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  ...
  gg.clearResults()
  gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
  gg.alert("ᴀɴᴛɪʙᴀɴ ᴠ 3 ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
gg.clearResults()
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ᴀɴᴛɪʙᴀɴ ᴠ 4 ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
gg.clearResults()
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ᴀɴᴛɪʙᴀɴ ᴠ 5 ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
function SRC()
  MN8 = gg.multiChoice({
          ...
          "➾ ꜱʀᴄ ᴏꜰꜰ",
          " ⫷ B Λ C K ⫸ "
}, nil,"🔰ᴜꜱᴇ ɪᴛ ꜰᴏʀ ꜰɪx ᴛᴇʀᴍɪɴᴀᴛɪᴏɴ ʙᴀɴ一🔥 ᴠ ᴀ ᴍ ᴘ ʏ 🔥")
    if MN8 == nil then
    else
      if MN8[1] == true then
        SRCON()
...
setvalue(so+py,4,56)
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ᴘʀᴏᴛᴇᴄᴛɪᴏɴ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
function CHEAT()
  MN8 = gg.multiChoice({
          ...
          "➾ ᴍᴀɢɪᴄ ʙᴜʟʟᴇᴛ",
          " ⫷ B Λ C K ⫸ "
}, nil,"🔰ᴜꜱᴇ ᴀᴛ ʏᴏᴜʀ ᴏᴡɴ ʀɪꜱᴋ一🔥 ᴠ ᴀ ᴍ ᴘ ʏ 🔥")
    if MN8 == nil then
    else
      if MN8[1] == true then
        ITEM1()
...
setvalue(so+py,16,-3.86856308e25)
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ᴀɪᴍʙᴏᴛ 300ᴍ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ɪᴘᴀᴅ ᴠɪᴇᴡ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ꜱᴍᴀʟʟ ᴄʀᴏꜱꜱʜᴀɪʀ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
setvalue(so + py, 16, 0)
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ʟᴇꜱꜱ ʀᴇᴄᴏɪʟ 50% ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
setvalue(so + py, 16, 0)
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ʟᴇꜱꜱ ʀᴇᴄᴏɪʟ 75% ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
setvalue(so+py,4,0)
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ʜᴇᴀᴅꜱʜᴏᴛ x ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ʙʟᴀᴄᴋ ꜱᴋʏ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ɴɪɢʜᴛ ᴍᴏᴅᴇ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ʙʟᴀᴄᴋ ʙᴏᴅʏ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
setvalue(so + py, 16, 0)
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ᴀɪᴍʙᴏᴛ ʜᴇᴀᴅ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ᴍᴇᴅɪᴜᴍ ꜱᴘᴇᴇᴅ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
gg.clearResults()
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ꜱᴛʀᴏɴɢ ʜᴇᴀᴅꜱʜᴏᴛ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
setvalue(so+py,16,0)
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ꜰᴀꜱᴛ ꜰɪʀᴇ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
setvalue(so+py,4,0)
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ᴡᴀʟʟ ꜱʜᴏᴏᴛ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
os.remove("/sdcard/Android/data/com.tencent.ig/cache/GCloud.ini")
gg.toast("ᴀᴄᴛɪᴠᴀᴛᴇᴅ✔️")
gg.alert("ᴍᴀɢɪᴄ ʙᴜʟʟᴇᴛ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
function SKIN()
  MN8 = gg.multiChoice({
          "➾ SOON...",
          " ⫷ B Λ C K ⫸ "
}, nil,"🔰ᴡᴇ ᴡɪʟʟ ᴀᴅᴅ ɪᴛ ꜱᴏᴏɴ...一🔥 ᴠ ᴀ ᴍ ᴘ ʏ 🔥")
    if MN8 == nil then
    else
      if MN8[1] == true then
        SKIN1()
...
print("━━━━━━━━━━━━━━━━━━━━━\n 🔥 ᴍᴀᴅᴇ ʙʏ  ᴠ ᴀ ᴍ ᴘ ʏ 🔥 \n ━━━━━━━━━━━━━━━━━━━━━")
print("💢Dᴏɴᴛ Fᴏʀɢᴇᴛ Tᴏ Jᴏɪɴ Iɴ Oᴜʀ Tᴇʟᴇɢʀᴀᴍ Cʜᴀɴɴᴇʟ Fᴏʀ Mᴏʀᴇ Uᴘᴅᴀᴛᴇꜱ")
print("⚜️ᴠᴀᴍᴘʏ ᴄʜᴇᴀᴛꜱ V.2⚜️")
gg.skipRestoreState()
  os.exit()
  gg.setVisible(true)
end 
