...
gg.alert(" ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴠᴀᴍᴘʏ ꜰᴏʀ ɢɢ ᴜꜱᴇʀꜱ  ", "Enter ","")
...
if ASR==1 then VAMPY1() end
if ASR==2 then VAMPY2() end
if ASR==3 then VAMPY3() end
if ASR==4 then VAMPY4() end
if ASR==5 then VAMPY5() end
if ASR==6 then VAMPY6() end
if ASR==7 then VAMPY7() end
if ASR==8 then VAMPY8() end
if ASR==9 then VAMPY9() end
...
setvalue(W+m,16,-2.0291021e20)
    ...
    gg.alert("ᴇᴍᴜ ʙᴘ+ʟᴏɢᴏ ᴀɴᴛɪʙᴀɴ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
...
gg.alert("ꜱᴀꜰᴇ ᴍᴀɢɪᴄ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ✔️")
end
